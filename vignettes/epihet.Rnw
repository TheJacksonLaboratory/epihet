...
\section{Background}
  ...
  by the user.
    ...
    locus was classified as a concordant read or a discordant read. Here, a concordant read is one that shows all unmethlated or all methylated sites at a given locus, such as a four methylated cytosines. A discordant
